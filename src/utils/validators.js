...
import { FieldValidationError, ValidationError } from '../models/errors.js';
  ...
  static validate(data, schema, fieldPath = '') {
    ...
    if (schema.properties && typeof data === 'object' && data !== null) {
      for (const [key, value] of Object.entries(data)) {
        // Skip undefined values for optional properties
        if (value === undefined) {
          continue;
        }
...
class Validator {
  ...
  /**
   * Generic validation method using schema with base property exclusion
   */
  static validateWithSchema(data, schema, operationType) {
    // Use the enhanced ValidationManager for validation with base property exclusion
    return ValidationManager.validateToolRequest(data, schema, operationType);
  }
...
export { Validator, SchemaValidator, schemas };
